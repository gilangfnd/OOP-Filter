...
const prepareFile = async (url) => { 
  ...
  if (url.endsWith('/')) paths.push('/home.html'); // routing jika membuka '/' di browser maka akan membuka file index.html
...
http.createServer(async (req, res) => {
  if(req.url === '/home'){ // routing bila di browser membuka link /tentang maka akan membuka file /about.html
    req.url = '/home.html'
  }
  if(req.url === '/rental'){ // routing bila di browser membuka link /tentang maka akan membuka file /about.html
    req.url = '/rental.html'
  }
